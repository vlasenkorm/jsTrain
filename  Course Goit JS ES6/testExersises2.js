//Написать фукнцию findLongestWord(str) которая получает аргументом произвольную строку ивозвращает самое длинное слово в этой строке. 
//Важное условие - в строке должны быть только пробелыи символы букв и цифр! 
// Функция должна проходить следующие проверки:
